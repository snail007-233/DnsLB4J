...
import com.snail.dnslb4j.dns.response.BitSet;
import com.snail.dnslb4j.dns.response.DnsException;
import java.io.*;
import java.net.IDN;
...
//      no  additionalResourceRecords
	...
	public static byte[] buildReponse(String ip,String domain, int id) {
		ByteArrayOutputStream baos = new ByteArrayOutputStream(512);
		DataOutputStream dos = new DataOutputStream(baos);
		BitSet bits = new BitSet();
...
//        class internet
	...
	public static Record[] parseResponse(byte[] response) throws IOException {
